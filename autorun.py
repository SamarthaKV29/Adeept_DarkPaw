...
path_get = str(search('//home/sam/projects/Adeept_DarkPaw/','server.py'))
...
if command_select == '1':
	try:
		try:
			os.system('sudo rm -rf //home/sam/projects/Adeept_DarkPaw/.config/autostart')
		except:
			pass
		os.system('sudo mkdir //home/sam/projects/Adeept_DarkPaw/.config/autostart')
		os.system('sudo touch //home/sam/projects/Adeept_DarkPaw/.config/autostart/car.desktop')
		with open("//home/sam/projects/Adeept_DarkPaw/.config/autostart/car.desktop",'w') as file_to_write:
